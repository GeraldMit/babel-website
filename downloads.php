...
<div id="maincontent">
	<div id="midcolumn">
		<h1>$pageTitle</h1>
		<h2>Babel Language Packs R0.15.0 are now available!</h2> 

		<p>Babel Language Packs R0.15.0 for Oxygen, Neon, and Mars release trains are now available!
			Translations in all languages for all projects in Babel up to 2017/08/19 are included in R0.15.0.</p>
		...
		<p><ul><li>Open the install wizard with 'Help' > 'Install new software...'</li> 
			<li>Add the Babel p2 repository: http://download.eclipse.org/technology/babel/update-site/R0.15.0/oxygen</li>
		...
		<h2>
			<a href="http://download.eclipse.org/technology/babel/babel_language_packs/R0.15.0/index.php">
			Babel Language Pack Zips and Update Sites - R0.15.0</a> (2017/08/19)
		</h2>
		<table>
			<tr>
			...
			<tr>
				<td>
					<a href="http://download.eclipse.org/technology/babel/babel_language_packs/R0.15.0/oxygen/oxygen.php">Oxygen</a> |
					<a href="http://download.eclipse.org/technology/babel/babel_language_packs/R0.15.0/neon/neon.php">Neon</a> |
					<a href="http://download.eclipse.org/technology/babel/babel_language_packs/R0.15.0/mars/mars.php">Mars</a>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					http://download.eclipse.org/technology/babel/update-site/R0.15.0/oxygen<br />
					<a href="http://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.15.0/babel-R0.15.0-oxygen.zip">Zipped p2 repository for Oxygen (117 MB)</a><br />
				</td>
			</tr>
			<tr>
				<td><img src="http://dev.eclipse.org/large_icons/actions/go-bottom.png" /></td>
				<td>
					...
					http://download.eclipse.org/technology/babel/update-site/R0.15.0/neon<br />
					<a href="http://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.15.0/babel-R0.15.0-neon.zip">Zipped p2 repository for Neon (116 MB)</a><br />
				</td>
			</tr>
				<tr>
				<td><img src="http://dev.eclipse.org/large_icons/actions/go-bottom.png" /></td>
				<td>
					...
					http://download.eclipse.org/technology/babel/update-site/R0.15.0/mars<br />
					<a href="http://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.15.0/babel-R0.15.0-mars.zip">Zipped p2 repository for Mars (143 MB)</a><br />
				</td>
			</tr>
		</table>

		<h2>Important notes for Babel Language Packs R0.15.0</h2>
		<ul>
