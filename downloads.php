...
<div id="maincontent">
	<div id="midcolumn">
		<h1>$pageTitle</h1>
		<h2>Babel Language Packs R0.17.0 are now available!</h2> 

		<p>Babel Language Packs R0.17.0 for 2019-06, 2018-12, and Photon release trains are now available!
			Translations in all languages for all projects in Babel up to 2019/07/13 are included in R0.17.0.</p>
		...
		<p><ul><li>Open the install wizard with 'Help' > 'Install new software...'</li> 
			<li>Add the Babel p2 repository: https://download.eclipse.org/technology/babel/update-site/R0.17.0/2019-06/</li>
		...
		<h2>
			<a href="https://download.eclipse.org/technology/babel/babel_language_packs/R0.17.0/index.php">Babel Language Pack Zips and Update Sites - R0.17.0</a> (2019/07/13)
		</h2>
		<table>
			<tr>
			...
			<tr>
				<td>
					<a href="https://download.eclipse.org/technology/babel/babel_language_packs/R0.17.0/2019-06/2019-06.php">2019-06</a> |
					<a href="https://download.eclipse.org/technology/babel/babel_language_packs/R0.17.0/2018-12/2018-12.php">2018-12</a> |
					<a href="https://download.eclipse.org/technology/babel/babel_language_packs/R0.17.0/photon/photon.php">Photon</a>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					https://download.eclipse.org/technology/babel/update-site/R0.17.0/2019-06/<br />
					<a href="https://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.17.0/babel-R0.17.0-2019-06.zip">Zipped p2 repository for 2019-06 (141 MB)</a><br />
				</td>
			</tr>
            <tr><td colspan="2">&#160;</td></tr>
			<tr>
				...
				<td>
					...
					https://download.eclipse.org/technology/babel/update-site/R0.17.0/2018-12/<br />
					<a href="https://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.17.0/babel-R0.17.0-2018-12.zip">Zipped p2 repository for 2018-12 (136 MB)</a><br />
				</td>
			</tr>
            <tr><td colspan="2">&#160;</td></tr>
			<tr>
				...
				<td>
					...
					https://download.eclipse.org/technology/babel/update-site/R0.17.0/photon/<br />
					<a href="https://eclipse.org/downloads/download.php?file=/technology/babel/update-site/R0.17.0/babel-R0.17.0-photon.zip">Zipped p2 repository for Photon (128 MB)</a><br />
				</td>
			</tr>
		</table>

		<h2>Important notes for Babel Language Packs R0.17.0</h2>
		<ul>
